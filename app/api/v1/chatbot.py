...
from app.core.langgraph.tools.generate_chart import _get_from_lru
...
async def get_model_info():
    ...
    Returns:
        ModelInfoResponse: The current model configuration.
    """
...
async def get_image(image_id: str):
    """Get a generated chart image by its cache ID.

    Args:
        image_id: The UUID returned by the generate_chart tool.

    Returns:
        PNG image bytes with image/png content type.
    """
    try:
        img_bytes = _get_from_lru(image_id)
