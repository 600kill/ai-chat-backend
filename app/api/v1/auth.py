...
async def delete_session(session_id: str, user: User = Depends(get_current_user)):
    """Delete a session belonging to the authenticated user.
...
async def get_all_users(current_user: User = Depends(get_current_user)):
    ...
    try:
        ...
        logger.exception("get_all_users_failed", error=str(e))
...
async def delete_user(user_id: int, current_user: User = Depends(get_current_user)):
    ...
    try:
        ...
        logger.exception("delete_user_validation_failed", user_id=user_id, error=str(ve))
        raise HTTPException(status_code=422, detail=str(ve))
    except Exception as e:
        logger.exception("delete_user_failed", user_id=user_id, error=str(e))
        raise HTTPException(status_code=500, detail=str(e))
...
async def get_all_sessions(current_user: User = Depends(get_current_user)):
    ...
    try:
        ...
        logger.exception("get_all_sessions_failed", error=str(e))
        raise HTTPException(status_code=500, detail=str(e))
...
async def delete_session_admin(
    ...
    try:
        ...
        logger.exception("delete_session_admin_validation_failed", session_id=session_id, error=str(ve))
        raise HTTPException(status_code=422, detail=str(ve))
    except Exception as e:
        logger.exception("delete_session_admin_failed", session_id=session_id, error=str(e))
        raise HTTPException(status_code=500, detail=str(e))
